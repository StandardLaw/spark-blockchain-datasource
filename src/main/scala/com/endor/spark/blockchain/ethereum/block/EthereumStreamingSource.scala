...
class EthereumStreamingSource(sparkSession: SparkSession,
  ...
  override def getBatch(start: Option[Offset], end: Offset): DataFrame = {
    ...
    val blockRelation = EthereumBlockRelation(false, files.map(_.path): _*)(sparkSession.sqlContext)
    import sparkSession.implicits._
    blockRelation.buildSimpleScan().toDS().toDF()
  }
  ...
  /**
    ...
    */
  @SuppressWarnings(Array("org.wartremover.warts.Var"))
  @volatile private[block] var sourceHasMetadata: Option[Boolean] =
